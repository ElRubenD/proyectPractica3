...
<head>
    ...
    <title>Municipalidad de Corrientes </title>
...
<nav class="navbar navbar-dark bg-dark">
    <a class="navbar-brand" href="#">
      <img src="{{ asset('logo-municipalidad.png') }}" width="35" height="35" class="d-inline-block align-top" alt="">
      Visor de Obras de Bacheo
    </a>
